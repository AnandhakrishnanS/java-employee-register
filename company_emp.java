...
static ArrayList<employees> employeeList = new ArrayList<>();


static abstract class employees {
...
static class full_time_emp extends employees {
...
static class part_time_emp extends employees {
    int hours_working;
    int hourly_rate;
...
static class commission_emp extends employees {
    int number_of_sales;
    double commission_percentage;
    double price_of_each_sale;
...
static class base_commission_emp extends commission_emp {
    double base_salary;

    @Override
    public double cal_income() {
        double tmp = number_of_sales * price_of_each_sale;
        return (commission_percentage / 100) * tmp + base_salary + (10 / 100 * base_salary);
    }
    ...
    public base_commission_emp(String first_name, String last_name, String ss_num, String type_con, double base_salary,
            int number_of_sales, double commission_percentage, double price_of_each_sale) {
...
public static void reg_emp() {
    ...
    switch (type) {
        ...
        case 4:
            ...
            sw.nextLine(); 
            employeeList.add(new base_commission_emp(f_na, l_na, ssn, tycon, baseSalary, baseSales,
                    baseCommission, basePrice));
            System.out.println("Employee registered sucessfully");
            sw.nextLine(); 
            break;
...
public static void print_emp_data(){
...
public static void print_emp_position(){
    for(employees x:employeeList){
        String pos="null";
        if(x instanceof full_time_emp){
            ...
            System.out.println("invalid employye type found");
        }
        System.out.println("  -----------------------------------------------");
...
public static void print_emp_contract(){
    for(employees x:employeeList){
        System.out.println("  -----------------------------------------------");
